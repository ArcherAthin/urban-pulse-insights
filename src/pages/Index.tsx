          ...
          <div className="container mx-auto max-w-4xl">
            <div className="glass-card p-8 text-center neon-border animate-on-scroll opacity-0">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Link to="/submit-issue" className="bg-urban-cyan hover:bg-urban-cyan/80 text-urban-navy font-medium px-8 py-3 rounded-xl glow-hover">
                  Report an Issue
                </Link>
                <Link to="/about" className="border border-urban-cyan text-urban-cyan hover:bg-urban-cyan/10 font-medium px-8 py-3 rounded-xl glow-hover">
                  Learn More
                </Link>
              </div>
            </div>
